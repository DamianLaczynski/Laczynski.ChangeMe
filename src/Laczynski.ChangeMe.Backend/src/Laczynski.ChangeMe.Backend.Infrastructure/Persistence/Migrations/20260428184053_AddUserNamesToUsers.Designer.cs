...
namespace Laczynski.ChangeMe.Backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260428184053_AddUserNamesToUsers")]
    partial class AddUserNamesToUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laczynski.ChangeMe.Backend.Domain.Aggregates.Issue.Entities.IssueHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("issue_history_entries", "laczynski_changeme_backend");
                });

            modelBuilder.Entity("Laczynski.ChangeMe.Backend.Domain.Aggregates.Issue.Entities.IssueWatcher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("issue_watchers", "laczynski_changeme_backend");
                });
            ...
            modelBuilder.Entity("Laczynski.ChangeMe.Backend.Domain.Aggregates.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("notifications", "laczynski_changeme_backend");
                });
