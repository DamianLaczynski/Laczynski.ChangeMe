...
// Import models
import { SelectOption, SelectChangeEvent } from '../../../ui/select/select.model';
import { InputChangeEvent } from '../../../ui/input/input.model';
import { CheckboxChangeEvent } from '../../../ui/checkbox/checkbox.model';
        ...
        <div class="interactive-controls">
          @for (control of config().controls; track control.id) {
            <div class="control-group" [class]="control.className">
              @switch (control.type) {
                @case ('select') {
                  <ds-form-field [label]="control.label" [required]="false">
                    <ds-select
                  ...
                  <ds-form-field [label]="control.label" [required]="false">
                    @for (option of getRadioOptions(control); track option.value) {
                      <ds-checkbox
                        ...
                        (checkedChange)="
                          onRadioOptionChange(control.property, option.value, $event)
                        "
                      />
                    }
                  </ds-form-field>
                ...
                @case ('range') {
                  <ds-form-field
                    [label]="control.label + ': ' + getControlValue(control.property)"
                    [required]="false"
                  >
                    <input
                      type="range"
  ...
  constructor() {
    ...
    effect(
      () => {
        ...
        const configChanged =
          JSON.stringify(currentConfigValue) !== JSON.stringify(currentInternal);
