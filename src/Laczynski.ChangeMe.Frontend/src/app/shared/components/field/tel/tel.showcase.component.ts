    ...
    <div class="showcase showcase--responsive showcase__with-toc">
      ...
      <div class="showcase__section">
        ...
        <p class="showcase__section__description">
          Inline edit allows users to edit phone number directly by clicking on it. Changes are saved
          on blur or Enter, and can be cancelled with Escape.
        </p>
        <div class="showcase__grid">
          <div class="showcase__item">
...
export class TelShowcaseComponent {
  ...
  inlineEditValue1 = '';
  inlineEditValue2 = '+1 (555) 123-4567';
}
