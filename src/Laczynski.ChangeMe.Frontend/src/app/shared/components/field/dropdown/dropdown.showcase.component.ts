      ...
      <div class="showcase-content">
        ...
        <div class="showcase__section">
          ...
          <p class="showcase__section__description">
            Inline edit allows users to edit dropdown selection directly by clicking on it. Changes
            are saved on blur or Enter, and can be cancelled with Escape.
          </p>
          <div class="showcase__grid">
            <div class="showcase__item">
            ...
            <div class="showcase__item">
              ...
              <p style="font-size: 12px; color: #666; margin-top: 8px;">
                Current value:
                <strong>{{
                  inlineEditValue3.length ? inlineEditValue3.join(', ') : '(empty)'
                }}</strong>
              </p>
            </div>
          </div>
